...
const LoginPage = () => {
  ...
  const navigate = useNavigate(); // to navigate after successful login or registration
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 flex flex-col items-center justify-start px-4 py-12 sm:px-6 lg:px-8">
      <p className="text-center text-lg font-semibold text-red-500 mb-6 mt-2">*please sign in or register to continue</p>
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg">
          ...
          {!isRegistering && (
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <a className="font-medium text-green-600 hover:text-blue-300 cursor-pointer">
            ...
            >
              {isSubmitting ? (
                ...
                <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                  <svg className="h-5 w-5 text-green-400 group-hover:text-green-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">
            ...
            <a 
              onClick={toggleMode}
              className="font-medium text-green-600 hover:text-blue-300 cursor-pointer"
            >
